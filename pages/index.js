        ...
        <div className='w-100 center'>
          ...
          <div className='db background-banner layout horizontal center sysFont' style={{'backgroundImage': 'url(/static/Header-bg.jpg)'}}>
            <div className='m-auto' style={{'textAlign': 'center', 'width': '80%', 'marginTop': '-50px', 'maxWidth': '1200px'}}>
              ...
              <form>
                <div className='mt0 m-auto layout horizontal flex searchBox wrap' style={{'width': '100%', 'height': '80px', 'maxWidth': '1000px'}}>
                  <div className='bg-white flex layout vertical justify-center f6 pa3' style={{'borderRight': '1px solid #eeeeee', 'textAlign': 'left'}}><span className='c-565656 pb2'>Welche Art Kurs suchst du?</span><span className='textSecondary'><input className='searchInput' value={what} onInput={(e) => this.setState({ what: e.target.value })} placeholder='Sprachkurs, Tanzkurs, ..' type='text' name='what' /></span></div>
                  <div className='bg-white flex layout vertical justify-center f6 pa3' style={{'borderRight': '1px solid #eeeeee', 'textAlign': 'left','borderTop': '1px solid #eeeeee'}}><span className='c-565656 pb2'>Wo</span><span className='textSecondary'><input className='searchInput' value={where} onInput={(e) => this.setState({ where: e.target.value })} placeholder='Stadt, Land, Region' type='text' name='where' /></span></div>
                  <div className='bg-white flex layout vertical justify-center f6 pa3' style={{'textAlign': 'left','borderTop': '1px solid #eeeeee'}}><span className='c-565656 pb2'>Wann</span><span className='textSecondary'><ReactDatePicker value={when} onChange={(date) => this.setState({ when: date })} /></span></div>
