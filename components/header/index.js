        ...
        <div className='headerWidth items-center justify-center'><Link href='/categories'><div className='ph3 h-100 f7 mid-gray pointer pv3'>KATEGORIEN</div></Link></div>
        {
          ...
          ? (
            <div className='layout horizontal wrap headerWidthDouble'>
              <div className='ph3 f7 mid-gray headerWidth pointer pv3' onClick={() => Router.push('/me')}>MEINE KURSE</div>
              <div className='ph3 f7 mid-gray headerWidth pointer pv3' onClick={() => this.logout()}>AUSLOGGEN</div>
            </div>
          )
          : (
            <div className='layout horizontal wrap headerWidthDouble'>
              ...
              <div className='ph3 f7 mid-gray headerWidth pointer pv3' onClick={() => { this.setState({ tab: 'login' }, () => this.refs.loginModal.openPortal()) }}>ANMELDUNG</div>
            </div>
          )
        }
